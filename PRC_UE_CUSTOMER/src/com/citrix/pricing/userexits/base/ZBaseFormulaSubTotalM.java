 ...
 */
public class ZBaseFormulaSubTotalM  extends BaseFormulaAdapter {
	public BigDecimal overwriteConditionBase(IPricingItemUserExit pricingItem,
	        IPricingConditionUserExit pricingCondition) {
	        return pricingItem.getSubtotal(PricingCustomizingConstants.ConditionSubtotal.SUBTOTAL_M).getValue();
	    }
}
