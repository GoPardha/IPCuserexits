 ...
 */
public class UnitRoundingDifference extends ValueFormulaAdapter {
    public BigDecimal overwriteConditionValue(IPricingItemUserExit pricingItem,
        ...
        if (pricingItem.getUserExitDocument().getUnitToBeRoundedTo() != 0) {
            ...
            BigDecimal condValue =
                condBaseValue.multiply((PricingTransactiondataConstants.HUNDRED).divide(roundingValue, scale,
            ...
            return condValue.subtract(condBaseValue);
        }
    ...
    public BigDecimal overwriteGroupConditionValue(IPricingDocumentUserExit pricingDocument,
        ...
        if (prItem != null) {
            BigDecimal condBaseValue = groupCondition.getConditionBase().getValue();
