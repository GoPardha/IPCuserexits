 ...
 */
public class SubtotalDMinusE extends ValueFormulaAdapter {
    public BigDecimal overwriteConditionValue(IPricingItemUserExit pricingItem,
        ...
        if (xworkd.compareTo(PricingTransactiondataConstants.ZERO) != 0) {
            return xworkd.subtract(pricingItem.getSubtotal(PricingCustomizingConstants.ConditionSubtotal.SUBTOTAL_E)
                                                  .getValue());
        }
